...
**Fase 9 — pendente:** (a) decidir alcance final (varrer tudo aceitando ~15-20% confiável OU focar listas fit + categorias saudáveis). (b) ingest em massa. (c) **integrar no gerador**: receita preenche o slot da refeição (escalável), micros da decomposição.
